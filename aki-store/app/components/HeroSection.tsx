...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-white dark:bg-gray-950">
      ...
      {/* Content */}
      <div className="relative z-20 mx-auto max-w-7xl px-6 py-24 sm:px-8 lg:px-12 lg:py-40">
        <div className="flex flex-col items-center text-center">

          {/* Tagline Badge */}
          <div className="mb-6 inline-flex items-center rounded-full border border-gray-200 bg-white/50 px-3 py-1 text-xs text-gray-600 backdrop-blur-sm dark:border-gray-800 dark:bg-gray-950/50 dark:text-gray-400">
          ...
          <h1 className="max-w-4xl text-4xl font-black tracking-tighter text-gray-900 dark:text-white sm:text-6xl md:text-7xl lg:text-8xl">
