            ...
            <div>
              ...
              <ul role="list" className="space-y-4">
                {footerLinks.platform.map((item) => (
                  <li key={item.name}>
                    <Link to={item.href} className="text-xs font-light tracking-wide text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors">
                      {item.name}
                    </Link>
                  </li>
                ))}
