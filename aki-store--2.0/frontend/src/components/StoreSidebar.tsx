    ...
    <aside className="sticky top-12 hidden w-64 shrink-0 flex-col gap-10 md:flex">
      ...
      <div className="flex flex-col gap-6">
        ...
        <ul className="flex flex-col gap-2">
          <li>
            <Link to={baseUrl} className="flex items-center justify-between px-3 py-3 text-sm font-medium tracking-wide text-gray-900 border-l-2 border-gray-900 dark:border-white transition-colors bg-gray-50 dark:bg-white/5 dark:text-white">
          ...
          <li>
            <Link to={`${baseUrl}?category=home`} className="flex items-center gap-4 border-l-2 border-transparent px-3 py-3 text-sm font-light tracking-wide text-gray-500 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-white transition-colors group">
          ...
          <li>
            <Link to={`${baseUrl}?category=music`} className="flex items-center gap-4 border-l-2 border-transparent px-3 py-3 text-sm font-light tracking-wide text-gray-500 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-white transition-colors group">
              <FontAwesomeIcon icon={faIcons}  className="h-4 w-4 group-hover:text-gray-900 dark:group-hover:text-white transition-colors"  />
              <span className="font-cinzel tracking-widest text-xs uppercase">Audio Fidelity</span>
            </Link>
          </li>
          <li>
            <Link to={`${baseUrl}?category=phone`} className="flex items-center gap-4 border-l-2 border-transparent px-3 py-3 text-sm font-light tracking-wide text-gray-500 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-white transition-colors group">
              <FontAwesomeIcon icon={faIcons}  className="h-4 w-4 group-hover:text-gray-900 dark:group-hover:text-white transition-colors"  />
              <span className="font-cinzel tracking-widest text-xs uppercase">Communication</span>
            </Link>
          </li>
          <li>
            <Link to={`${baseUrl}?category=storage`} className="flex items-center gap-4 border-l-2 border-transparent px-3 py-3 text-sm font-light tracking-wide text-gray-500 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-white transition-colors group">
              <FontAwesomeIcon icon={faIcons}  className="h-4 w-4 group-hover:text-gray-900 dark:group-hover:text-white transition-colors"  />
