        ...
        <div className="w-full max-w-sm mx-auto">
          ...
          <form className="space-y-8" action="/store-admin">
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <Link to="/auth/reset-password" className="text-xs font-light tracking-wide text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
                Recover Access
              </Link>
            </div>
          ...
          <div className="mt-12 text-center">
            <p className="text-xs font-light text-gray-500 tracking-wide">
              Do not maintain a presence? <Link to="/auth/signup" className="text-gray-900 hover:text-gray-600 dark:text-white dark:hover:text-gray-300 font-medium ml-1 transition-colors">Establish a Boutique</Link>
            </p>
          </div>
