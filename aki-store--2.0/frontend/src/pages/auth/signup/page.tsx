...
import { faArrowLeft, faShieldAlt, faBolt, faGlobe } from '@fortawesome/free-solid-svg-icons';
            ...
            <div className="space-y-8 pl-2">
              <div className="flex gap-6 items-start">
                <div className="mt-1 flex h-6 w-6 shrink-0 items-center justify-center">
                  <FontAwesomeIcon icon={faBolt}  className="h-5 w-5 text-gray-400"  />
                </div>
                <div>
        ...
        <div className="w-full max-w-sm mx-auto">
          ...
          <form className="space-y-8" action="/onboarding">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <label className="text-xs font-light tracking-wide text-gray-500 dark:text-gray-400">
                I accept the <Link to="/terms" className="text-gray-900 dark:text-white hover:text-gray-500 dark:hover:text-gray-300 transition-colors">Terms of Service</Link>
              </label>
            </div>
          ...
          <div className="mt-12 text-center">
            <p className="text-xs font-light text-gray-500 tracking-wide">
              Already a member? <Link to="/auth/login" className="text-gray-900 hover:text-gray-600 dark:text-white dark:hover:text-gray-300 font-medium ml-1 transition-colors">Enter Atelier</Link>
            </p>
          </div>
