    ...
    if (items.length === 0) {
        return (
            <div className="flex min-h-screen flex-col items-center justify-center bg-[#fcfcfc] p-4 dark:bg-[#050505]">
                <FontAwesomeIcon icon={faShoppingBag} className="mb-8 h-16 w-16 text-gray-300 dark:text-gray-700" />
                ...
                <Link to="/explore" className="mt-10 border border-gray-900 bg-gray-900 px-8 py-3 text-xs font-semibold uppercase tracking-widest text-white transition-all hover:bg-transparent hover:text-gray-900 dark:border-white dark:bg-white dark:text-black dark:hover:bg-transparent dark:hover:text-white">
                    Enter the Directory
                </Link>
            </div>
        );
        ...
        <div className="min-h-screen bg-[#fcfcfc] dark:bg-[#050505] pt-24 pb-16 transition-colors">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-12 border-b border-gray-200 dark:border-white/10 pb-6">
                    <Link to="/" className="inline-flex items-center gap-3 text-xs font-semibold uppercase tracking-widest text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
                        <FontAwesomeIcon icon={faArrowLeft} className="h-4 w-4" /> Return to Store
                    </Link>
                </div>
                            ...
                            <div className="pt-8">
                                ...
                                <div className="mt-8 flex items-center justify-center gap-8 border-t border-gray-200 dark:border-white/10 pt-6">
                                    <div className="flex items-center gap-3 text-xs tracking-widest uppercase font-light text-gray-500">
                                        <FontAwesomeIcon icon={faShieldAlt} className="h-4 w-4" /> Secured
                                    </div>
                                    <div className="flex items-center gap-3 text-xs tracking-widest uppercase font-light text-gray-500">
                                        <FontAwesomeIcon icon={faTruck} className="h-4 w-4" /> Insured Logistics
                                    </div>
                                </div>
                            </div>
                        </form>
