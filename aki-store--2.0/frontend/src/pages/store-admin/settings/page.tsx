...
import { faStore, faImage, faSave, faPalette, faMoon, faSun, faDesktop, faCheckCircle } from '@fortawesome/free-solid-svg-icons';
        ...
        <div className="flex justify-end pt-4 items-center gap-4">
          {isSaved && (
            <span className="flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-[#25D366] transition-opacity duration-300">
              <FontAwesomeIcon icon={faCheckCircle} className="h-4 w-4" /> Saved Successfully
            </span>
          )}
          <button
            onClick={handleSave}
          ...
          >
            <FontAwesomeIcon icon={faSave} className="h-4 w-4" /> Save Configurations
          </button>
        </div>
